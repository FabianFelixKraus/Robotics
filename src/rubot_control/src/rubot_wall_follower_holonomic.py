...
scanRangesLengthCorrectionFactor = 3.16944
...
def clbk_laser(msg):
    ...
    fright_max = int(180 * scanRangesLengthCorrectionFactor)
    ...
    #front_max = int(180 * scanRangesLengthCorrectionFactor)

    fleft_min = int(180 * scanRangesLengthCorrectionFactor)
    fleft_max = int(280 * scanRangesLengthCorrectionFactor)

    left_min = int(280 * scanRangesLengthCorrectionFactor)
    left_max = int(350 * scanRangesLengthCorrectionFactor)
...
def take_action(regions):
    ...
    if regions['left'] > 2*d and regions['fright'] > 2*d:
    ...
    rospy.loginfo("regions['fleft'] %5.2f", regions['fleft'])
